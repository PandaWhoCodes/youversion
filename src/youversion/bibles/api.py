"""Bible API implementation - async-first design."""
...
class HTTPAdapter(Protocol):
    """Protocol for HTTP adapters - works with both sync and async."""
...
class BibleAPIMixin:
    """Mixin providing Bible API methods - async-first implementation."""
